            ...
            <div class="mixitup-gallery">
                <div class="filters clearfix">
                	...
                	<ul class="filter-tabs filter-btns text-center clearfix">
                        ...
                        <li class="filter" data-role="button" data-filter=".dinner">Dinner</li>
                        <li class="filter" data-role="button" data-filter=".hour">Happy Hour</li>
                        <li class="filter" data-role="button" data-filter=".beverages">Beverages</li>
                        <li class="filter" data-role="button" data-filter=".desserts">Desserts</li>
                    </ul>
                ...
                <div class="filter-list row clearfix">
					...
					<div class="gallery-block-two mix all desserts hour col-lg-6 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								...
								<div class="overlay-box">
									<div class="overlay-inner">
										<div class="content">
											<a href="images/gallery/17.jpg" data-fancybox="main-gallery" data-caption="" class="icon"><img src="images/icons/cap-5.png" alt="" /></a>
										</div>
									</div>
						...
						<div class="inner-box">
							<div class="image">
								...
								<div class="overlay-box">
									<div class="overlay-inner">
										<div class="content">
											<a href="images/gallery/18.jpg" data-fancybox="main-gallery" data-caption="" class="icon"><img src="images/icons/cap-5.png" alt="" /></a>
										</div>
									</div>
									<div class="lower-content">
										<div class="title">Desert</div>
...
<!-- Mirrored from codexlayer.com/html/comida_punto/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Oct 2022 09:51:17 GMT -->
</html>